...
def p_RA_kpi_veh(*args,**kwargs):
    ...
    ret = ret[['ACCEPTANCE_RATE','PROFIT','PROFIT/hour','IDLE_TIME','nREQUESTS','nRIDES','nREJECTS','DRIVING_DIST','AVE_DRIVING_DIST',
               'DRIVING_TIME','AVE_PICKUP_DIST','AVE_TRIP_DIST','REVENUE','REVENUE/hour','COST','IMPOSED_DELAY']]#+ [_.name for _ in driverEvent]]
